...
仓库根目录的 `CNAME` 文件内容为 `clips.clutchreframe.com`，已推送。
...
1. 打开 https://github.com/ClutchReframe/Clips-website/settings/pages
2. 找到 **Custom domain** 输入框，输入 `clips.clutchreframe.com`
3. 点击 **Save**
...
1. `https://clips.clutchreframe.com` — 应显示首页
2. `https://clips.clutchreframe.com/privacy.html` — 隐私政策
3. `https://clips.clutchreframe.com/terms.html` — 服务条款
4. `https://clips.clutchreframe.com/riot.txt` — 应返回纯文本 UUID
